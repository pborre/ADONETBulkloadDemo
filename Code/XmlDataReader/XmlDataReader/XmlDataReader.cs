...
namespace Riziv.BizTalk.Common
{
    ...
    {   
        ...
        protected IEnumerator<XmlDocumentFragment> m_enumerator;
        ...
        public XmlDocumentFragment CurrentElement
        {
        ...
        /// <returns></returns>
        private IEnumerable<XmlDocumentFragment> GetXmlStream()
        {
            XmlDocument doc;
            XmlDocumentFragment rowElement;
            //XElement rowElement;
            ...
            using (m_xmlReader)
            {
                ...
                while (m_xmlReader.Read())
                {
                    if (IsRowElement())
                    {
                        ...
                        doc = new XmlDocument();
                        rowElement = doc.CreateDocumentFragment();
                        XmlNode child = doc.ReadNode(m_xmlReader);
