namespace MedegaImport.Pipelines
{
    ...
    public sealed class MedegaImportFile : Microsoft.BizTalk.PipelineOM.ReceivePipeline
    {
...
"sd:string\">MedegaImportSchema.Schemas.Medega_Guard, RIZIV.MedegaImportSchema, Version=2.0.0.0, Cultu"+
"re=neutral, PublicKeyToken=7d624d93bf081b87</Value>            </Property>            <Property Name"+
"=\"DocumentSpecTargetNamespaces\">              <Value xsi:type=\"xsd:string\">http://www.riziv.fgov.be/"+
"medega/v1.0</Value>            </Property>            <Property Name=\"AllowUnrecognizedMessage\">    "+
"          <Value xsi:type=\"xsd:boolean\">false</Value>            </Property>            <Property Na"+
"me=\"ValidateDocument\">              <Value xsi:type=\"xsd:boolean\">true</Value>            </Property"+
...
"s />    </Stage>    <Stage>      <PolicyFileStage _locAttrData=\"Name\" _locID=\"4\" Name=\"ResolveParty\""+
" minOccurs=\"0\" maxOccurs=\"-1\" execMethod=\"All\" stageId=\"9d0e410e-4cce-4536-83fa-4a5040674ad6\" />    "+
"  <Components />    </Stage>  </Stages></Document>";
        
        private const string _versionDependentGuid = "48870a9e-20e0-4a6e-bed0-2daeb06b323a";
        
        public MedegaImportFile()
        {
...
"   <Value xsi:type=\"xsd:string\">MedegaImportSchema.Schemas.Medega_Guard, RIZIV.MedegaImportSchema, V"+
"ersion=2.0.0.0, Culture=neutral, PublicKeyToken=7d624d93bf081b87</Value>    </Property>    <Property"+
" Name=\"DocumentSpecTargetNamespaces\">      <Value xsi:type=\"xsd:string\">http://www.riziv.fgov.be/med"+
"ega/v1.0</Value>    </Property>    <Property Name=\"AllowUnrecognizedMessage\">      <Value xsi:type=\""+
"xsd:boolean\">false</Value>    </Property>    <Property Name=\"ValidateDocument\">      <Value xsi:type"+
"=\"xsd:boolean\">true</Value>    </Property>    <Property Name=\"RecoverableInterchangeProcessing\">    "+
